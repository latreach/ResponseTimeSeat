...
tweetCriteria = got.manager.TweetCriteria().setQuerySearch("SEAT_Mexico").setSince('2017-03-10').setUntil("2017-03-13")
...
Mentions.to_csv("/home/datascience/local/seat_analisis_extras/ResponseTime/Mentions2.csv", header=True, index=False, encoding="utf-8")
#%history -f /home/datascience/local/seat_analisis_extras/ResponseTime/historialMentions.py
